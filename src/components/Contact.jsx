...
const Contact = () => {
  ...
  return (
    <div className="h-screen text-3xl py-20 bg-[#080021]" id="contact">
          ...
          <div className='grid grid-cols-2 gap-x-4'>
            <div>
              <div className='flex flex-col w-[95%]'>
                <div className='text-4xl normal_bold text-white'>
                    Get in Touch
                </div>
                <div className='text-2xl opacity-50 normal_bold bg-gradient-to-l to-10% from-neutral-600 to-white
                    text-transparent bg-clip-text'>
                    Have questions or something exciting in mind? Let’s make it happen.
                </div>
                <div type="text" className='w-full h-20 bg-neutral-50/10 outline-0 rounded-xl p-2 text-xl text-white mt-5 flex flex-col justify-center'>
