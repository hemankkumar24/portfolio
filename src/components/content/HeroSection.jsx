...
const HeroSection = () => {
  return (
    <div className='my-15 flex justify-between font-light h-[55%] w-full overflow-x-hidden border-white items-center'>
        ...
        <img src={hemank} alt="" className='w-[400px] h-[400px] filter grayscale border-2  rounded-full backdrop-contrast-50 contrast-120 border-b-white border-l-white border-t-0 border-r-0'/>
    </div>
  )
}
